...
-- MAGIC %fs ls dbfs:/mnt/ssdatabricksadls/raw/

-- COMMAND ----------

create table delta.demo2(id int, name string, age int) LOCATION 'abfss://raw@ssdatabricksadls.dfs.core.windows.net/delta/demo2'
